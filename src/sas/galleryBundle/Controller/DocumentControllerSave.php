...
use sas\galleryBundle\Entity\Document;
use sas\galleryBundle\Form\DocumentType;
...
class DocumentController extends Controller
{
     ...
     * @Route("/", name="document")
     * @Method("GET")
     * @Template("galleryBundle:Document:index.html.twig")
     */
    public function indexAction()
    {
        $entities = $this->getDoctrine()->getRepository('galleryBundle:Document');
     ...
     * @Method("POST")
     * @Template("galleryBundle:Document:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('galleryBundle:Document')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("galleryBundle:Document:edit.html.twig")
     */
     ...
     * @Template("galleryBundle:Document:upload.html.twig")
     */
