...
use sas\galleryBundle\Entity\Work;
use sas\galleryBundle\Form\WorkType;
...
class WorkController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('galleryBundle:Work')->findAll();
     ...
     * @Method("POST")
     * @Template("galleryBundle:Work:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('galleryBundle:Work')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("galleryBundle:Work:edit.html.twig")
     */
